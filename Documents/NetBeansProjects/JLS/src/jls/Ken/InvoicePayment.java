...
public class InvoicePayment extends javax.swing.JFrame {
    Object[][] empty = {{"","",null,}};
    Object[][] rowData_1 = {{"O001", "25/11/2018", 15.00},
                {"O004", "26/11/2018", 65.00},
                {"O013", "2/12/2018", 150.00},
                {"O014","2/12/2018", 18.00},
                {"O036", "7/12/2018", 20.00}};
    Object[] columnNames = {"Order ID", "Order Date", "Total Bill"};
    
    Object[][] rowData_2 = {{"O003", "25/11/2018", 45.00},
                {"O005", "25/11/2018", 25.00},
                {"O007", "27/11/2018", 45.00},
                {"O015","2/12/2018", 70.00},
                {"O031", "5/12/2018", 55.00}};
    ...
    private void initComponents() {
        ...
        jTabbedPane1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18Ny
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        if(found == 0)
            ...
            if(name.equals("tong chun ken"))
                // Get data into the object, and put into table
